...
from core.crypto import ensure_active_keypair
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # 生成/修复密钥
        keypair = ensure_active_keypair(org)
        self.stdout.write(self.style.SUCCESS(f"当前活跃 PGP 密钥 Key ID: {keypair.key_id}"))
